...
class StyleProxy : public StyleBase<StyleProxy> {
 ...
 private:
  ...
  lv_color_t get_bg_color() const {
    return lv_obj_get_style_bg_color(obj_,
                                     lv_obj_style_get_selector_part(selector_));
  }
  void set_bg_opa(lv_opa_t v) { lv_obj_set_style_bg_opa(obj_, v, selector_); }
  lv_opa_t get_bg_opa() const {
    return lv_obj_get_style_bg_opa(obj_,
                                   lv_obj_style_get_selector_part(selector_));
  }
  ...
  lv_grad_dir_t get_bg_grad_dir() const {
    return lv_obj_get_style_bg_grad_dir(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  lv_color_t get_border_color() const {
    return lv_obj_get_style_border_color(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_border_width() const {
    return lv_obj_get_style_border_width(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  lv_opa_t get_border_opa() const {
    return lv_obj_get_style_border_opa(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_pad_left() const {
    return lv_obj_get_style_pad_left(obj_,
                                     lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_pad_column() const {
    return lv_obj_get_style_pad_column(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_margin_left() const {
    return lv_obj_get_style_margin_left(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_margin_right() const {
    return lv_obj_get_style_margin_right(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_margin_top() const {
    return lv_obj_get_style_margin_top(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_margin_bottom() const {
    return lv_obj_get_style_margin_bottom(
        obj_, lv_obj_style_get_selector_part(selector_));
  }

  void set_width(int32_t v) { lv_obj_set_style_width(obj_, v, selector_); }
  int32_t get_width() const {
    return lv_obj_get_style_width(obj_,
                                  lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_min_width() const {
    return lv_obj_get_style_min_width(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_min_height() const {
    return lv_obj_get_style_min_height(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_max_height() const {
    return lv_obj_get_style_max_height(
        obj_, lv_obj_style_get_selector_part(selector_));
  }

  void set_x(int32_t v) { lv_obj_set_style_x(obj_, v, selector_); }
  int32_t get_x() const {
    return lv_obj_get_style_x(obj_, lv_obj_style_get_selector_part(selector_));
  }
  void set_y(int32_t v) { lv_obj_set_style_y(obj_, v, selector_); }
  int32_t get_y() const {
    return lv_obj_get_style_y(obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_radius() const {
    return lv_obj_get_style_radius(obj_,
                                   lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_translate_x() const {
    return lv_obj_get_style_translate_x(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_translate_y() const {
    return lv_obj_get_style_translate_y(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_transform_scale_x() const {
    return lv_obj_get_style_transform_scale_x(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_transform_scale_y() const {
    return lv_obj_get_style_transform_scale_y(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  int32_t get_transform_scale_x_safe() const {
    return lv_obj_get_style_transform_scale_x_safe(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  int32_t get_transform_scale_y_safe() const {
    return lv_obj_get_style_transform_scale_y_safe(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_transform_rotation() const {
    return lv_obj_get_style_transform_rotation(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  lv_color_t get_text_color() const {
    return lv_obj_get_style_text_color(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  lv_color_t get_text_color_filtered() const {
    return lv_obj_get_style_text_color_filtered(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  lv_opa_t get_text_opa() const {
    return lv_obj_get_style_text_opa(obj_,
                                     lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_text_letter_space() const {
    return lv_obj_get_style_text_letter_space(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_text_line_space() const {
    return lv_obj_get_style_text_line_space(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  void set_text_align(lv_text_align_t v) {
    lv_obj_set_style_text_align(obj_, v, selector_);
  }
  // set_recolor(bool) removed as it is no longer supported in LVGL v9
  ...
  lv_color_t get_recolor() const {
    return lv_obj_get_style_recolor(obj_,
                                    lv_obj_style_get_selector_part(selector_));
  }
  lv_opa_t get_recolor_opa() const {
    return lv_obj_get_style_recolor_opa(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  lv_color_t get_recolor_recursive() const {
    lv_color32_t c32 = lv_obj_get_style_recolor_recursive(
        obj_, lv_obj_style_get_selector_part(selector_));
  ...
  int32_t get_arc_width() const {
    return lv_obj_get_style_arc_width(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  lv_opa_t get_opa() const {
    return lv_obj_get_style_opa(obj_,
                                lv_obj_style_get_selector_part(selector_));
  }
  ...
  const lv_color_filter_dsc_t* get_color_filter_dsc() const {
    return lv_obj_get_style_color_filter_dsc(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  lv_opa_t get_color_filter_opa() const {
    return lv_obj_get_style_color_filter_opa(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  const lv_anim_t* get_anim() const {
    return lv_obj_get_style_anim(obj_,
                                 lv_obj_style_get_selector_part(selector_));
  }
  ...
  lv_opa_t get_opa_recursive() const {
    return lv_obj_get_style_opa_recursive(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  ...
  int32_t get_space_top() const {
    return lv_obj_get_style_space_top(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  int32_t get_space_bottom() const {
    return lv_obj_get_style_space_bottom(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  int32_t get_space_left() const {
    return lv_obj_get_style_space_left(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  int32_t get_space_right() const {
    return lv_obj_get_style_space_right(
        obj_, lv_obj_style_get_selector_part(selector_));
  }

  lv_color_t get_bg_color_filtered() const {
    return lv_obj_get_style_bg_color_filtered(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  lv_color_t get_border_color_filtered() const {
    return lv_obj_get_style_border_color_filtered(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  lv_color_t get_outline_color_filtered() const {
    return lv_obj_get_style_outline_color_filtered(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  lv_color_t get_shadow_color_filtered() const {
    return lv_obj_get_style_shadow_color_filtered(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  lv_color_t get_line_color_filtered() const {
    return lv_obj_get_style_line_color_filtered(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  lv_color_t get_arc_color_filtered() const {
    return lv_obj_get_style_arc_color_filtered(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  lv_color_t get_text_outline_stroke_color_filtered() const {
    return lv_obj_get_style_text_outline_stroke_color_filtered(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  lv_color_t get_bg_grad_color_filtered() const {
    return lv_obj_get_style_bg_grad_color_filtered(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  lv_color_t get_image_recolor_filtered() const {
    return lv_obj_get_style_image_recolor_filtered(
        obj_, lv_obj_style_get_selector_part(selector_));
  }
  lv_color_t get_bg_image_recolor_filtered() const {
    return lv_obj_get_style_bg_image_recolor_filtered(
        obj_, lv_obj_style_get_selector_part(selector_));
  }

  lv_style_value_t get_prop(lv_style_prop_t prop) const {
    return lv_obj_get_style_prop(
        obj_, lv_obj_style_get_selector_part(selector_), prop);
  }
  ...
  lv_style_value_t get_prop_inlined(lv_style_prop_t prop) const {
    lv_style_value_t v;
    lv_obj_get_local_style_prop(obj_, prop, &v, selector_);
    return v;
  }
