...
class Object {
 public:
  ...
  /**
   * @brief Alignment options mirroring lv_align_t.
   */
  enum class Align {
   ...
   */
  void align(Align align_type, int32_t x_ofs = 0, int32_t y_ofs = 0);
   ...
   */
  void align_to(const Object& base, Align align_type, int32_t x_ofs = 0,
                int32_t y_ofs = 0);
